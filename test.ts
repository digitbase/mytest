...
console.log(getNextMonth('2019-1-31'))
console.log(getNextMonth('2019-1-30'))
console.log(getNextMonth('2019-1-29'))
console.log(getNextMonth('2019-1-28'))
console.log(getNextMonth('2019-1-27'))
console.log(getNextMonth('2019-1-2'))


function getNextMonth(time?:any): Date {
