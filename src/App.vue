  ...
  <div id="app">
    ...
    class="table"
     ...
     >
       ...
       <el-table-column prop="masterName" label="masterName" width=""></el-table-column>
       <el-table-column prop="createdDate" label="createdDate" width=""></el-table-column>
...
export default {
  ...
  created(){
    ...
    axios.get("http://192.168.31.186:3004/service/Inspection/0.1.0/InspectionCheckGroup/GetTree",data,{
        headers:{
